...
export function ApprovedHero({locale}:{locale:Locale}){
  ...
  return <section id="top" className="approved-hero" data-section-id="H01" data-testid="approved-h01">
    ...
    <div className="approved-hero-media">
      ...
      <ReferenceCrop slot="home.hero.people-group" crop={{x:335,y:55,w:689,h:399}} className="approved-hero-people" label={ar?"تكوين توضيحي لمهن متعددة":"Illustrative multi-profession uniform composition"}/>
