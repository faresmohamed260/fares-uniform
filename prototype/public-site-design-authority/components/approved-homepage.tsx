 ...
 return <section id="industries" className="approved-industries" data-section-id="H02" data-testid="approved-h02">
  ...
  : key==="hospitality"
    ...
    : key==="healthcare"
      ...
      : key==="corporate"
        ? <img data-media-slot="home.industries.corporate" className="approved-industry-image approved-industry-generated" src="/generated/home-industries-corporate.webp" alt={ar?arabic:en}/>
        : key==="industrial"
          ? <img data-media-slot="home.industries.industrial" className="approved-industry-image approved-industry-generated" src="/generated/home-industries-industrial.webp" alt={ar?arabic:en}/>
          : key==="security"
            ? <img data-media-slot="home.industries.security" className="approved-industry-image approved-industry-generated" src="/generated/home-industries-security.webp" alt={ar?arabic:en}/>
...
export function ApprovedSelectedWork({locale}:{locale:Locale}){
 ...
 return <section id="about" className="approved-selected-work" data-section-id="H04" data-testid="approved-h04">
  ...
  : c.slot==="home.work.hospitality"
    ...
    : c.slot==="home.work.healthcare"
      ? <img data-media-slot={c.slot} className="approved-work-image approved-work-generated" src="/generated/home-industries-healthcare.webp" alt={ar?"مشهد رعاية صحية توضيحي عام":"Generic illustrative healthcare scene"}/>
