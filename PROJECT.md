...
1. **Track A / active — Fares visual review:** review the protected supplied-brand and H01 copy/scene-note candidate at [`fares-uniform-design-authority-21ztre66e.vercel.app/en`](https://fares-uniform-design-authority-21ztre66e.vercel.app/en) from exact deployed/evidence source `b772883fb2f41a1e2febed77aadfc3561993ffaa`; record approval or concrete corrections against that exact candidate.
