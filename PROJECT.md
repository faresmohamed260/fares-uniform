...
- **Track A — Public website:** the current H01 three-scene implementation source is `57279bf264bd30657f7c6ee64fbfd5c015d9fe65`. Slide 01 uses a sharper independent people cutout; slide 02 depicts illustrative design/cutting; slide 03 depicts illustrative sewing/finishing. Existing 01/02/03 pagination selects scenes; the visible non-reduced-motion hero auto-advances every 5.5 seconds and pauses on hover/focus. Browser-native copy, geometry, notes, controls and four benefits remain separate; H00/H02-H06 remain intact. Design-authority run/job `36058741414` / `107832186795` passed typecheck, production build and 11/11 browser checks. Exact-source full candidate run/job `36058743206` / `107832191890` is GREEN. Protected non-production preview: https://fares-uniform-design-authority-e0oryaqx4.vercel.app/en. Generated scenes are illustrative, not evidence of an actual Fares facility. Final visual approval remains Fares's; production, PR merges and public client publication remain NO-GO.- **Track B — ERP/Odoo:** core MVP engineering, Gate C staging acceptance and Phase 0–8 release integration are complete. Remaining work is Gate D, production ownership/operations, real-business configuration/onboarding and controlled launch readiness.
