...
- **Track A — Public website:** active protected H01 visual review at exact implementation source `57279bf264bd30657f7c6ee64fbfd5c015d9fe65`. Fares rejected the earlier H01 layout for incorrect scale/placement and a backdrop that did not fill the hero. The current H01 uses the independent full-frame 1672×941 architectural environment `home-hero-architecture-courtyard-v2.png`, preserves independent copy, people, blue geometry, notes, controls, four benefits and pagination, and leaves H00/H02–H06 intact. Design-authority push run/job `36042807578` / `107778886072` passed typecheck, production build and **10/10 browser checks**; artifact `10827591187`, digest `sha256:ab77dcde9ef926cc7283f986645f684fecc18e659de3328cca6f56d2c9675c05`. Exact protected preview: https://fares-uniform-design-authority-e0oryaqx4.vercel.app/en (READY, non-production, anonymous HTTP 302). Exact-source full candidate run/job `36043155293` / `107780044403` is GREEN; artifact `10828130998`, digest `sha256:044631e8997fff334ebb7c2151dcdd5d9672515d347a56ad38d432e6d7d2283e`. Live authenticated inspection covered reference-size 1672×941 and wide 2560×1440 desktop, 390×844 English and Arabic RTL with zero horizontal overflow and no console errors. Fares final visual approval remains pending; production remains NO-GO.
Latest H01 three-scene evidence: slide 01 uses a sharper independent people cutout; slide 02 depicts illustrative design/cutting; slide 03 depicts illustrative sewing/finishing. Existing 01/02/03 pagination selects scenes; the visible non-reduced-motion hero auto-advances every 5.5 seconds and pauses on hover/focus. Design-authority run/job 36058741414 / 107832186795 passed typecheck, production build and 11/11 browser checks on implementation SHA 57279bf264bd30657f7c6ee64fbfd5c015d9fe65. Exact-source full candidate run/job 36058743206 / 107832191890 is GREEN. Protected non-production preview: https://fares-uniform-design-authority-e0oryaqx4.vercel.app/en. Generated scenes are illustrative, not evidence of an actual Fares facility. Final visual approval remains Fares's; production, PR merges and public client publication remain NO-GO.
...
1. **Track A / active — Fares visual review:** review the protected H01 composition correction at [`fares-uniform-design-authority-e0oryaqx4.vercel.app/en`](https://fares-uniform-design-authority-e0oryaqx4.vercel.app/en) from exact deployed/evidence source `57279bf264bd30657f7c6ee64fbfd5c015d9fe65`; record approval or concrete corrections against that exact candidate.
