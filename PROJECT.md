...
- **Track A — Public website:** active protected H01 visual review at exact implementation source `c459160ef85057653b6f96dcf968085bfcd44fac`. Fares rejected the earlier H01 layout for incorrect scale/placement and a backdrop that did not fill the hero. The current H01 uses the independent full-frame 1672×941 architectural environment `home-hero-architecture-courtyard-v2.png`, preserves independent copy, people, blue geometry, notes, controls, four benefits and pagination, and leaves H00/H02–H06 intact. Design-authority push run/job `36013792420` / `107680978667` passed typecheck, production build and **10/10 browser checks**; artifact `10813916611`, digest `sha256:e6012bb7d41944a15cbe6d8a05a1e5ad5405b76501638b0a3f8e1764720d919d`. Exact protected preview: https://fares-uniform-design-authority-370ltzqu8.vercel.app/en (READY, non-production, anonymous HTTP 302). Exact-source full candidate run/job `36015174980` / `107685733080` is GREEN; artifact `10814850003`, digest `sha256:8a7c6f54201d2c270fb0b2300f34ec29ffaf13cfd94eb24b077b609261bd0a14`. Live authenticated inspection covered reference-size 1672×941 desktop, 390×844 English and Arabic RTL with zero horizontal overflow and no console errors. Fares final visual approval remains pending; production remains NO-GO.
...
The previous browser candidates through `418fd78423a2cee3102b402e96c32a9208935b6b` are rejected historical evidence: the sequence includes screenshot-backed D-062 output, the fixed-board/`zoom` patch, and the first fluid D-063 composition whose scrolling remained too basic. The current protected homepage review candidate is the H01 composition correction at exact source `c459160ef85057653b6f96dcf968085bfcd44fac`, retaining the D-064 immersive implementation introduced at `fb3ee67978d71ff0aa5d0f2ac2a809f502e700dc` for H02–H06. The historical 1024 board remains content/regression evidence only and no longer supplies runtime media or geometry.
...
1. **Track A / active — Fares visual review:** review the protected H01 composition correction at [`fares-uniform-design-authority-370ltzqu8.vercel.app/en`](https://fares-uniform-design-authority-370ltzqu8.vercel.app/en) from exact deployed/evidence source `c459160ef85057653b6f96dcf968085bfcd44fac`; record approval or concrete corrections against that exact candidate.
