...
2. Gather discovery round 5: POS payments/returns/collection, staff responsibilities and devices/connectivity/languages.
...
Awaiting discovery round 5 answers. No technical blocker to continuing discovery. Deployment configuration, service resource selection, user roles, language, devices, scale and budget remain unconfirmed.
