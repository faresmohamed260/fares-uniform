...
- **Track A — Public website:** active now. Fares approved a new H01 visual target while keeping H00 and H02–H06 unchanged. The hero-only implementation authority is exact source `ce95c50156475241e54e215f0d8169cbf0368007` (`be2d3393265451636dcdc271cbd87997d77645ed` main composition plus `ce95c501...` mobile separation). It preserves D-064 Scrollcraft/H03 architecture while rebuilding H01 as independent browser-native copy, people, blurred environment, blue geometry, notes, controls, benefit row and pagination layers. The Canva environment-only asset `MAHWGkAE9WA` is used only as a soft background; the screenshot is reference-only. Exact design-authority push run/job `36004327244` / `107648476096` passed typecheck, production build and **10/10 browser checks**; artifact `10810300436`, digest `sha256:71be19a77e1858fc62d07fe49cd7ee3584de1b9e9fb76578713f083d26a5430b`. Protected preview [`fares-uniform-design-authority-e9dunbps9.vercel.app`](https://fares-uniform-design-authority-e9dunbps9.vercel.app) is READY, non-production, exact Git SHA `ce95c501...`, anonymous HTTP 302. Exact-SHA workflow-dispatch full candidate run/job `36004641173` / `107649549124` is GREEN; artifact `10810401496`, digest `sha256:6821a5daeab2fadcd6dee32814c62bbec10b1c1d33ce33e23643f2c88b379e83`. Live authenticated inspection covered 1920×1080 desktop, 390×844 mobile, Arabic RTL and the story dialog; hosted reduced-motion coverage is GREEN. Fares visual acceptance remains pending; production remains NO-GO.
...
The previous browser candidates through `418fd78423a2cee3102b402e96c32a9208935b6b` are rejected historical evidence: the sequence includes screenshot-backed D-062 output, the fixed-board/`zoom` patch, and the first fluid D-063 composition whose scrolling remained too basic. The current protected homepage review candidate is the H01 refinement at exact source `ce95c50156475241e54e215f0d8169cbf0368007`, retaining the D-064 immersive implementation introduced at `fb3ee67978d71ff0aa5d0f2ac2a809f502e700dc` for H02–H06. The historical 1024 board remains content/regression evidence only and no longer supplies runtime media or geometry.
...
1. **Track A / active — Fares visual review:** review the protected H01-refined homepage at [`fares-uniform-design-authority-e9dunbps9.vercel.app/en`](https://fares-uniform-design-authority-e9dunbps9.vercel.app/en) from exact deployed/evidence source `ce95c50156475241e54e215f0d8169cbf0368007`; record approval or concrete corrections against that exact candidate.
