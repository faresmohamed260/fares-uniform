...
- **Track A — Public website:** active now. Fares rejected the first fluid D-063 candidate because the scrolling still felt inert and the Industry/Selected Work/closing media read like cropped/recycled screenshots. D-064 is now implemented at exact review source `d124f2ed3050bb05301f94a993a8e4946bfe23d6` (main choreography commit `fb3ee67978d71ff0aa5d0f2ac2a809f502e700dc`). It uses the pinned Scrollcraft runtime for layered hero depth and the single deliberate H03 Seam Handoff peak, removes all six Industry portrait bitmaps plus the CTA-building bitmap from runtime/repository tip, keeps only truth-grounded KGC photography in Selected Work, and replaces non-client imagery with browser-native CSS/SVG sector/capability/architecture fields. Exact design-authority push run/job `35936560302` / `107434784604` passed typecheck, production build and **10/10 browser checks**; artifact `10783157813`, digest `sha256:6d23a6b3dcac519832e4ba8f1c4f7bdc2221fd95ef0b7c9279ba4f2b3fb0ac3b`. Protected preview [`fares-uniform-design-authority-hgg8uke49.vercel.app`](https://fares-uniform-design-authority-hgg8uke49.vercel.app) is deployment `dpl_56q3Tqx1k7XnNZQKE1c1JMELxQGY`, READY, non-production, exact Git SHA `d124f2ed...`, anonymous HTTP 302. Full hosted candidate run/job `35936563841` / `107434794869` is GREEN; artifact `10783093123`, digest `sha256:1f3f8329933d6187a2c21f4dc819bcce88e5eba1c30fbc0f0ce384c7dbbc9337`. Fares visual acceptance remains pending; production remains NO-GO.
...
The previous browser candidates through `418fd78423a2cee3102b402e96c32a9208935b6b` are rejected historical evidence: the sequence includes screenshot-backed D-062 output, the fixed-board/`zoom` patch, and the first fluid D-063 composition whose scrolling remained too basic. The current protected homepage review candidate is D-064 source `d124f2ed3050bb05301f94a993a8e4946bfe23d6`, carrying the immersive implementation introduced at `fb3ee67978d71ff0aa5d0f2ac2a809f502e700dc`. The historical 1024 board remains content/regression evidence only and no longer supplies runtime media or geometry.
...
1. **Track A / active — Fares visual review:** review the protected D-064 homepage at [`fares-uniform-design-authority-hgg8uke49.vercel.app/en`](https://fares-uniform-design-authority-hgg8uke49.vercel.app/en) from exact deployed/evidence source `d124f2ed3050bb05301f94a993a8e4946bfe23d6`; record approval or concrete corrections against that exact candidate.
