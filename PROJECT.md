...
The previous browser candidates through `418fd78423a2cee3102b402e96c32a9208935b6b` are rejected historical evidence: the sequence includes screenshot-backed D-062 output, the fixed-board/`zoom` patch, and the first fluid D-063 composition whose scrolling remained too basic. The current protected homepage review candidate is the H01 composition correction at exact source `57279bf264bd30657f7c6ee64fbfd5c015d9fe65`, retaining the D-064 immersive implementation introduced at `fb3ee67978d71ff0aa5d0f2ac2a809f502e700dc` for H02–H06. The historical 1024 board remains content/regression evidence only and no longer supplies runtime media or geometry.
