...
1. **Track A / active — Fares visual review:** review the protected supplied-brand and H01 copy/scene-note candidate at [`fares-uniform-design-authority-33euraes2.vercel.app/en`](https://fares-uniform-design-authority-33euraes2.vercel.app/en) from exact deployed/evidence source `f6291c60460fce9f1613291d4f5cf36e83857d4a`; record approval or concrete corrections against that exact candidate.
