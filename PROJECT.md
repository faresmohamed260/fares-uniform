...
- **Track A — Public website:** active now. Fares rejected the fixed 1024×1536/whole-page-`zoom` D-063 patch and authorized a true viewport-native correction. Implementation `5803d43e0234239bb72f97047e60b52a86634263` replaces the scaled board with a fluid full-width header, viewport-scale layered hero, real overflowing Industries/Selected Work rails, distinct H03/H05 visual chapters and passive native-scroll choreography; final evidence commit `418fd78423a2cee3102b402e96c32a9208935b6b` differs only by moving mobile opening captures ahead of rail interaction. Exact push run/job `35932633422` / `107422500513` passed typecheck, production build and **10/10 browser checks**. Artifact `10782081070` has digest `sha256:6013b9af6e2a564dbca6b61041315edcc1a386e30eba26116d17be7ceab5ef31`. Protected preview [`fares-uniform-design-authority-6huouwjii.vercel.app`](https://fares-uniform-design-authority-6huouwjii.vercel.app) is deployment `dpl_5SFvdCn5yCKZqPBuU6tTMJt2z9CX`, READY, non-production (`target: null`), exact Git SHA `418fd784...`, and anonymous access fails closed with HTTP `302`. Full hosted candidate run/job `35932637678` / `107422513104` is GREEN; artifact `10781712247`, digest `sha256:8c28c956a700638fcc79b7eeafdeafc01076ed19e69674c37fac9f0694ab06a6`. Fares visual acceptance is still pending; production remains NO-GO.
...
The previous browser candidate `bfdb85d53a76b3f81b521631e39265fea3fb72e1`, the D-062 screenshot-backed endpoints, the superficially GREEN `204769b17f369e563a8b45ded6cf4c4f175fe287` preview, and the later fixed-board/`zoom` candidate `1510dcc32471ce9c1155b739e44ce863fb4c2ef1` are rejected historical evidence. The current protected review candidate is exact source `418fd78423a2cee3102b402e96c32a9208935b6b` carrying viewport-native implementation `5803d43e0234239bb72f97047e60b52a86634263`. The historical 1024 reference remains content/regression evidence only; fixed-board pixel-parity metrics are no longer an acceptance gate for this explicitly fluid composition.
...
1. **Track A / active — Fares visual review:** review the protected viewport-native homepage at [`fares-uniform-design-authority-6huouwjii.vercel.app/en`](https://fares-uniform-design-authority-6huouwjii.vercel.app/en) from exact deployed/evidence source `418fd78423a2cee3102b402e96c32a9208935b6b` (implementation `5803d43e0234239bb72f97047e60b52a86634263`); record approval or concrete corrections against that exact candidate.
2. Preserve the new browser-native authority: no root `zoom`/whole-page transform scaling, fluid H00–H06 composition, native scrolling, real rail/dialog/menu interactions, content-only runtime imagery, EN/AR RTL, reduced-motion parity and zero horizontal overflow. The old fixed-board pixel-difference thresholds are historical regression evidence, not a geometry requirement.
