...
**Mandatory public-site UI/UX authority rule:** read `docs/ui/REPO_FIRST_UI_UX_WORKFLOW.md` and `.agents/skills/fares-scrollcraft/SKILL.md` before any public-site visual, interaction, layout, component or motion work. D-059 supersedes screenshot/image boards as implementation authority; D-060 requires the pinned Scrollcraft + Astra 10K workflow for the current premium design authority.
