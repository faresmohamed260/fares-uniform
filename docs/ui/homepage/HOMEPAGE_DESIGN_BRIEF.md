...
**H01→H02 scroll refinement requested by Fares (2026-09-25):** keep the blue diagonal as one compact, continuous handoff instead of a large blue panel plus a second empty band. Sections should settle near their starts through native section scroll snapping (normal stop, with free travel inside oversized chapters; proximity only for reduced motion), accounting for the sticky header. Preserve free scrolling within taller chapters, normal wheel/touch/keyboard behavior, EN/AR RTL, reduced-motion information parity and no horizontal overflow. This is a review-candidate interaction correction, not production or visual approval.
...
## Brand-led H00/H01 review direction (2026-09-25)

Fares asked for the hero to lead with the company name, taking hierarchy inspiration from the supplied Jadore screenshot without copying its gold palette, child illustration, or layout as a pixel specification. The supplied FARES/UNIFORM wordmark is the large H01 headline; adjacent live text states design/manufacturing, and the body identifies Fares Uniform and its multi-sector work. The hero actions match their destinations: Explore Industries -> H02; See Our Process -> H03. The former Watch Our Story play control/text modal is removed because it implied a video. H00 navigation and brand are enlarged for readability; Start a Project leads to the existing enquiry route. Later sections, three scenes, notes, benefits, RTL/mobile behavior and Scrollcraft handoff remain in the regression scope. This is a review candidate pending Fares visual approval.
