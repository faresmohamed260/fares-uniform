...
| home.work.kgc | project proof placeholder | 324,1097,173,149 | **protected real-media placeholder:** `review-media/kgc/kgc-building.webp` from the rights-authorized private KGC review set; campus context only, never published publicly without explicit authorization |
