...
| home.feature.design-sketch | decorative pattern illustration | H03 split right field | **independent browser-safe review asset:** `prototype/public-site-design-authority/public/generated/home-feature-pattern-blue.svg`, Git blob `140e1daf657dc800d3ba77659d9c7500abc4ddc1`; abstract blue patternmaking lines only, no client, product, facility, or performance claim; H03 option 3 approved concept is not runtime media |
| home.work.kgc | protected real worn/model anchor | H04 selected-work feature | `/review-media/kgc/high-summer.png` from the rights-authorized private KGC review set; original High/Summer worn/model image, never public without explicit approval |
| home.work.kgc.campus | protected real campus context | H04 selected-work feature | `/review-media/kgc/kgc-building.webp` from the existing protected review set; separate context photograph, not a composite scene |
