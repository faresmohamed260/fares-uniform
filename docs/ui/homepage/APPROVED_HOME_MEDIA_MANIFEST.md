...
The first fidelity implementation may crop the committed reference image as a temporary sprite source. This preserves the approved composition while media is generated or later sourced from Odoo/R2.
...
| home.work.kgc | project proof placeholder | 324,1097,173,149 | **protected real-media composition:** `primary-summer.png` + `high-summer.png` from the rights-authorized private KGC review set; rendered as two real uniform views, never published publicly |
